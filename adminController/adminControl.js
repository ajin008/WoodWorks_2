...
exports.viewOrderedDetails = async (req, res) => {
  try {
    ...
    const orderDetails = await MyOrder.findById(orderId);
    if (!orderDetails) {
...
exports.ReturnedOrderRendering = async (req, res) => {
  try {
    ...
    // Fetch all return orders and populate the 'orderId' field
...
exports.renderSalesReport = async (req, res, next) => {
  try {
    ...
    // Add logging to check the fetched return orders
    ...
    // Add logging to check the processed return order details
